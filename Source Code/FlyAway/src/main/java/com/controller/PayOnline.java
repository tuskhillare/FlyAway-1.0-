...
public class PayOnline extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Integer securitycode = Integer.parseInt(request.getParameter("securitycode"));
		...
		try {
			...
			Integer personflightidConverted = Integer.parseInt(personflightid);
			...
			Integer resultFromQ1 = (Integer) session.createQuery(query).getSingleResult();
